...
import com.example.authservice.event.UserDataEventProducer;
...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthenticationResponse register(CreateUserRequest request) {
        ...
        SyncUserMessage message = new SyncUserMessage(savedUser.getId(), savedUser.getName(), savedUser.getPhone(), savedUser.getAge(), savedUser.getEmail());
